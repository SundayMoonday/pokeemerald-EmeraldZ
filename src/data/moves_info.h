...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_SAND_ATTACK] =
    {
        ...
        .description = COMPOUND_STRING(
            "Reduces the foe's awareness\n"
            "by hurling sand in its face."),
        .effect = EFFECT_AWARENESS_DOWN,
        .power = 0,
        .type = TYPE_GROUND,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_SWEET_SCENT] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Reaction."),
        .effect = B_UPDATED_MOVE_DATA >= GEN_6 ? EFFECT_REACTION_DOWN_2 : EFFECT_REACTION_DOWN,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 20,
