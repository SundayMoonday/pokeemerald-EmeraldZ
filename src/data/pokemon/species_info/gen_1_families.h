...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        .baseHP        = 40,                                                    
        .baseAttack    = 55,                                                    
        .baseDefense   = P_UPDATED_STATS >= GEN_6 ? 45 : 35,                    
        .baseSpeed     = 90,                                                    
        .baseSpAttack  = 50,                                                    
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .baseDefense   = 73,
        .baseSpeed     = 65,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_6 ? 100 : 95,
        .baseSpDefense = 90,
		.baseReaction  = 60,
        .baseAwareness = 85,
        .types = CLEFAIRY_FAMILY_TYPES,
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_ELECTRODE] =
    {
		...
		.baseReaction  = 105,									
        .baseAwareness = 50,
		.baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 130 : 120,
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 60,
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_FLAREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_GUTS, ABILITY_FUR_COAT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_MAGIC_BOUNCE, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_UMBREON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_INNER_FOCUS, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_GLACEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_ICE_BODY, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SYLVEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_DAZZLING, ABILITY_PIXILATE },
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_ARTICUNO_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_COMPETITIVE, ABILITY_NONE, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Articuno"),
        .cryId = CRY_ARTICUNO,
        .natDexNum = NATIONAL_DEX_ARTICUNO,
    ...
    [SPECIES_ZAPDOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_NONE, ABILITY_DRIZZLE },
    #else
    ...
    [SPECIES_ZAPDOS_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_DEFIANT, ABILITY_NONE, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Zapdos"),
        .cryId = CRY_ZAPDOS,
        .natDexNum = NATIONAL_DEX_ZAPDOS,
    ...
    [SPECIES_MOLTRES_GALAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_BERSERK, ABILITY_NONE, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Moltres"),
        .cryId = CRY_MOLTRES,
        .natDexNum = NATIONAL_DEX_MOLTRES,
    ...
    [SPECIES_MEWTWO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_UNNERVE, ABILITY_NONE, ABILITY_JUSTIFIED },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MEWTWO_MEGA_X] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_JUSTIFIED, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Mewtwo"),
    ...
    [SPECIES_MEW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_WONDER_SKIN, ABILITY_PRANKSTER, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_PINK,
        .speciesName = _("Mew"),
        .cryId = CRY_MEW,
