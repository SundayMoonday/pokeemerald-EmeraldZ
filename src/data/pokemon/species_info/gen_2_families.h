...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_EARLY_BIRD, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_RED,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_DAZZLING, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                               \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                                      \
        .abilities = { ABILITY_ALPHA_POWER, ABILITY_NONE, ABILITY_NONE },                                  \
        .bodyColor = BODY_COLOR_BLACK,                                                                  \
        .noFlip = _noFlip,                                                                              \
        .speciesName = _("Unown"),                                                                      \
        .cryId = CRY_UNOWN,                                                                             \
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_KEEN_EYE, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_TRACE, ABILITY_MOODY },
    #else
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_FLASH_FIRE },
    #else
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_WATER_ABSORB },
    #else
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_GALE_WINGS, ABILITY_NONE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Lugia"),
        .cryId = CRY_LUGIA,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_GALE_WINGS, ABILITY_NONE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_LEGENDARY),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_NONE, ABILITY_SERENE_GRACE },
        .bodyColor = BODY_COLOR_GREEN,
