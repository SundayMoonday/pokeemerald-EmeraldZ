...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_GOOEY, ABILITY_STORM_DRAIN },
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_GOOEY, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
        .natDexNum = NATIONAL_DEX_SLIGGOO,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NONE, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_NONE, ABILITY_STEAM_ENGINE },
        .bodyColor = BODY_COLOR_BROWN,
