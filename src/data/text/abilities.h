...
static const u8 sFieldExpertDescription[] = _("Strengthens field moves");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
	...
	[ABILITY_FIELD_EXPERT] = _("Field Expert"),
};
#else   // 12 characters
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_TOXIC_CHAIN] = _("Toxic Chain"),
    [ABILITY_SUPERSWEET_SYRUP] = _("Super Syrup"),
	[ABILITY_FIELD_EXPERT] = _("Field Expert"),
};
#endif
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
	...
	[ABILITY_FIELD_EXPERT] = sFieldExpertDescription,
};
