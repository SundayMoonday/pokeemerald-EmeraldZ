...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12, BALL_QUICK },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 2 },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 2 },
    ...
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12, BALL_ULTRA },
    ...
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 15, BALL_PREMIER },
    ...
    [TRAINER_CLASS_SIS_AND_BRO] = { _("SIS AND BRO"), 6 },
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (i = 0; i < monsCount; i++)
        {
            ...
            if (partyData[monIndex].ev != NULL)
            {
				...
				SetMonData(&party[i], MON_DATA_REACT_EV, &(partyData[monIndex].ev[6]));
                SetMonData(&party[i], MON_DATA_AWARE_EV, &(partyData[monIndex].ev[7]));
            }
...
u32 GetBattlerTotalSpeedStatArgs(u32 battler, u32 ability, u32 holdEffect)
{
    ...
    if (holdEffect == HOLD_EFFECT_MACHO_BRACE || holdEffect == HOLD_EFFECT_POWER_ITEM)
        ...
        speed *= 2;
	else if (holdEffect == HOLD_EFFECT_ZOOM_LENS)
        react *= (react * 150) / 100;
