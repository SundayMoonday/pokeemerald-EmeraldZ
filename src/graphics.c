...
const u32 gStatAnim_Reaction_Pal[]     = INCBIN_U32("graphics/battle_anims/stat_change/reaction.gbapal.lz");
const u32 gStatAnim_Awareness_Pal[]    = INCBIN_U32("graphics/battle_anims/stat_change/awareness.gbapal.lz");
