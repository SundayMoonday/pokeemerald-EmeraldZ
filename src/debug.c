...
static const u8 sDebugText_IV_Awareness[] =              _("IV Awareness:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
...
static const u8 sDebugText_EV_Reaction[] =              _("EV Reaction:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
static const u8 sDebugText_EV_Awareness[] =             _("EV Awareness:{CLEAR_TO 90}\n    {STR_VAR_3}{CLEAR_TO 90}\n{CLEAR_TO 90}\n{STR_VAR_2}{CLEAR_TO 90}");
...
static void DebugAction_Give_Pokemon_SelectIVs(u8 taskId)
{
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        case STAT_SPDEF:
            ...
            break;
		case STAT_REACT:
            StringExpandPlaceholders(gStringVar4, sDebugText_IV_Reaction);
            break;
        case STAT_AWARE:
            StringExpandPlaceholders(gStringVar4, sDebugText_IV_Awareness);
            break;
        }
        AddTextPrinterParameterized(gTasks[taskId].tSubWindowId, DEBUG_MENU_FONT, gStringVar4, 0, 0, 0, NULL);
    }
    ...
    if (JOY_NEW(A_BUTTON))
    {
		...
		case STAT_REACT:
            ...
            break;
        case STAT_AWARE:
            sDebugMonData->mon_iv_aware = gTasks[taskId].tInput;
            break;
        }
...
static u32 GetDebugPokemonTotalEV(void)
{
    return (sDebugMonData->mon_ev_hp
		  ...
		  + sDebugMonData->mon_ev_react
          + sDebugMonData->mon_ev_aware);
}
...
static void DebugAction_Give_Pokemon_SelectEVs(u8 taskId)
{
    ...
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        case STAT_SPDEF:
            ...
            break;
		case STAT_REACT:
            StringExpandPlaceholders(gStringVar4, sDebugText_EV_Reaction);
            break;
        case STAT_AWARE:
            StringExpandPlaceholders(gStringVar4, sDebugText_EV_Awareness);
            break;
        }
        AddTextPrinterParameterized(gTasks[taskId].tSubWindowId, DEBUG_MENU_FONT, gStringVar4, 0, 0, 0, NULL);
    }
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        else
        {
            ...
            if (totalEV > MAX_TOTAL_EVS)
            {
                ...
                sDebugMonData->mon_ev_satk = 0;
                sDebugMonData->mon_ev_sdef = 0;
				sDebugMonData->mon_ev_react = 0;
                sDebugMonData->mon_ev_aware = 0;
...
static void DebugAction_Give_Pokemon_ComplexCreateMon(u8 taskId) //https://github.com/ghoulslash/pokeemerald/tree/custom-givemon
{
    ...
    IVs[7]          = sDebugMonData->mon_iv_aware;
	...
	EVs[6]          = sDebugMonData->mon_ev_react;
    EVs[7]          = sDebugMonData->mon_ev_aware;
