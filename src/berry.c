...
static const u8 sBerryDescriptionPart1_Durin[] = _("Bitter to even look at. Just one bite");
static const u8 sBerryDescriptionPart2_Durin[] = _("is enough to instantly stop hiccups.");
