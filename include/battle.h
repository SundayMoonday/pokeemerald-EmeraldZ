...
#define GET_STAT_BUFF_ID(n) ((n & 15))              // first three bits 0x1, 0x2, 0x4
#define GET_STAT_BUFF_VALUE_WITH_SIGN(n) ((n & 0xF0))
#define GET_STAT_BUFF_VALUE(n) (((n >> 4) & 0xF))      // 0x8, 0x10, 0x20, 0x40
