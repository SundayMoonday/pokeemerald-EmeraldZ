...
#define TRAINER_PARTY_IVS(hp, atk, def, speed, spatk, spdef, react, aware) (hp | (atk << 4) | (def << 8) | (speed << 12) | (spatk << 16) | (spdef << 20) | (react << 24) | (aware << 28))
#define TRAINER_PARTY_EVS(hp, atk, def, speed, spatk, spdef, react, aware) ((const u8[8]){hp,atk,def,spatk,spdef,speed,react,aware})
