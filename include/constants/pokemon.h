...
#define NATURE_AUSTERE  25 // +Atk -React
#define NATURE_WILD     26 // +Atk -Aware
#define NATURE_WARY     27 // +Def -React
#define NATURE_STRICT   28 // +Def -Aware
#define NATURE_POLITE   29 // +SpAtk -React
#define NATURE_SPACEY   30 // +SpAtk -Aware
#define NATURE_WISE     31 // +SpDef -React
#define NATURE_JEALOUS  32 // +SpDef -Aware
#define NATURE_PROUD    33 // +Speed -React
#define NATURE_VALIANT  34 // +Speed -Aware
#define NATURE_SHY      35 // +React -Atk
#define NATURE_CURIOUS  36 // +React -Def
#define NATURE_ALERT    37 // +React -SpAtk
#define NATURE_SILLY    38 // +React -SpDef
#define NATURE_ANXIOUS  39 // +React -Speed
#define NATURE_SUAVE    40 // +Aware -Atk
#define NATURE_PASSIVE  41 // +Aware -Def
#define NATURE_SKEPTIC  42 // +Aware -SpAtk
#define NATURE_DEVOTED  43 // +Aware -SpDef
#define NATURE_PATIENT  44 // +Aware -Speed
#define NATURE_ALOOF    45 // Neutral
#define NATURE_ERRATIC  46 // +React -Aware 
#define NATURE_FOCUSED  47 // +Aware -React
#define NATURE_ZEALOUS  48 // Neutral
...
enum EvolutionMethods {
    ...
    EVO_ITEM_COINS,                     // 999 GameCorner coins are given to this Pokémon 
