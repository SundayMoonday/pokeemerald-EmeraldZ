...
#define ITEM_EFFECT_REACT_EV 18
#define ITEM_EFFECT_AWARE_EV 19
#define ITEM_EFFECT_EVO_STONE 20
#define ITEM_EFFECT_PP_UP 21
#define ITEM_EFFECT_PP_MAX 22
#define ITEM_EFFECT_HEAL_PP 23
#define ITEM_EFFECT_NONE 24
